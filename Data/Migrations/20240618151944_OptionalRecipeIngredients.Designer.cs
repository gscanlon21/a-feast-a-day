...
namespace Web.Migrations
{
    ...
    [Migration("20240618151944_OptionalRecipeIngredients")]
    partial class OptionalRecipeIngredients
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IngredientUser", b =>
                {
                    b.Property<int>("IngredientExclusionsId")
                        .HasColumnType("integer");

                    b.Property<int>("UserExclusionsId")
                        .HasColumnType("integer");

                    b.HasKey("IngredientExclusionsId", "UserExclusionsId");

                    b.HasIndex("UserExclusionsId");
            ...
            modelBuilder.Entity("IngredientUser", b =>
                {
                    b.HasOne("Data.Entities.User.Ingredient", null)
                        .WithMany()
                        .HasForeignKey("IngredientExclusionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Data.Entities.User.User", null)
                        .WithMany()
                        .HasForeignKey("UserExclusionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
