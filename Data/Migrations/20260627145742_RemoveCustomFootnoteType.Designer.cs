...
namespace Data.Migrations
{
    ...
    [Migration("20260627145742_RemoveCustomFootnoteType")]
    partial class RemoveCustomFootnoteType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.Nutrients.DietaryIntake", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Data.Entities.Nutrients.Nutrient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Data.Entities.Users.UserNutrient", b =>
                {
                    ...
                    b.Property<double>("RDAScale")
                        .HasColumnType("double precision");

                    b.Property<double>("TULScale")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("Data.Entities.Ingredients.IngredientAttr", b =>
                {
                    b.HasOne("Data.Entities.Ingredients.Ingredient", "Ingredient")
                        .WithOne("IngredientAttr")
                        .HasForeignKey("Data.Entities.Ingredients.IngredientAttr", "IngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
