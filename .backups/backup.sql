...
\restrict pReQ9EWOM94QBhVAPtPOGekYyiyMAxgLeiYssNqXUEopIavP7TrR3ByvK7hzQKu
...
CREATE TABLE public.dietary_intake (
    ...
    "Updated" date DEFAULT '-infinity'::date NOT NULL,
    "Checked" date DEFAULT '-infinity'::date NOT NULL,
    "Notes" text
);
...
SELECT pg_catalog.setval('public."dietary_intake_Id_seq"', 412, true);
...
SELECT pg_catalog.setval('public."nutrient_Id_seq"', 22539, true);
...
\unrestrict pReQ9EWOM94QBhVAPtPOGekYyiyMAxgLeiYssNqXUEopIavP7TrR3ByvK7hzQKu
